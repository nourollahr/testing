...
class UploadImageControllerTest extends TestCase
{
     ...
     * @return void
     */
    public function testUploadMethodValidationRequestImageDataHasMaximumWithAndMinimumHeightRule()
    {
        $image = UploadedFile::fake()
            ->image('image.png', 101, 10)
            ->size(50);
     ...
     * @return void
     */
    public function testUploadMethodValidationRequestImageDataHasMinimumWithAndMaximumHeightRule()
    {
        $image = UploadedFile::fake()
            ->image('image.png', 10, 201)
            ->size(50);
